...
import { ArrowDownLeft, X, Smartphone, CheckCircle2, AlertCircle, Copy, Info } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 mt-1 flex items-center gap-1">
              ...
              Copy the transaction ID from your MTN/Airtel Mobile Money confirmation SMS.
            </p>
          </div>
