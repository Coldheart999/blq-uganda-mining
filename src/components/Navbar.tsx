          ...
          <div className="flex items-center space-x-2">
            {currentUser ? (
              ...
              <div className="flex items-center space-x-2">
                <button
                  onClick={openAdmin}
                  className="px-2.5 py-1.5 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-400 font-semibold text-xs rounded-xl transition-all flex items-center gap-1.5"
